...
export async function GET(request: NextRequest) {
  try {
    ...
    authorizationUrl.searchParams.set(
      "scope",
      "openid profile capabilities:read account:read shops:read shops:write templates:read templates:write byok:read byok:write connectors:write emails:read emails:write",
    );
