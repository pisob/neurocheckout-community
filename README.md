...
and note the latest tag. The example below uses `v0.1.0-preview.8`:

```bash
git clone --branch v0.1.0-preview.8 --depth 1 \
...
GNUPGHOME="${verification_home}" git verify-tag v0.1.0-preview.8
