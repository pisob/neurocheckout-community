...
and note the latest tag. The example below uses `v0.1.0-preview.14`:

```bash
git clone --branch v0.1.0-preview.14 --depth 1 \
...
GNUPGHOME="${verification_home}" git verify-tag v0.1.0-preview.14
